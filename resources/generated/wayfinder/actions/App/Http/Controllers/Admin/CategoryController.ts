...
* @see app/Http/Controllers/Admin/CategoryController.php:83
...
* @see app/Http/Controllers/Admin/CategoryController.php:95
...
* @see app/Http/Controllers/Admin/CategoryController.php:108
* @route '/admin/categories/{category}'
*/
