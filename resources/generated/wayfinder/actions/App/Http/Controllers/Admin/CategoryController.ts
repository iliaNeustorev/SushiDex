...
* @see app/Http/Controllers/Admin/CategoryController.php:63
* @route '/admin/categories'
*/
...
* @see app/Http/Controllers/Admin/CategoryController.php:86
...
* @see app/Http/Controllers/Admin/CategoryController.php:99
* @route '/admin/categories/{category}'
*/
