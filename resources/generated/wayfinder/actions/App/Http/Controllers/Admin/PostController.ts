...
* @see app/Http/Controllers/Admin/PostController.php:37
* @route '/admin/posts'
*/
...
* @see app/Http/Controllers/Admin/PostController.php:83
...
* @see app/Http/Controllers/Admin/PostController.php:94
* @route '/admin/posts'
*/
...
* @see app/Http/Controllers/Admin/PostController.php:110
...
* @see app/Http/Controllers/Admin/PostController.php:125
...
* @see app/Http/Controllers/Admin/PostController.php:140
* @route '/admin/posts/{post}'
*/
...
* @see app/Http/Controllers/Admin/PostController.php:152
