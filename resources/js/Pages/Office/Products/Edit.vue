...
const props = defineProps<{ product: ProductCrudResource, categories: CategoryCrudResource[], images: ImageCrudResource[] }>();
...
<template>
    <DefaultLayout><OfficeWrapper>
        ...
        <VCard class="my-4"><VCardText><VRow><VCol v-for="image in images" :key="image.id" cols="2">
